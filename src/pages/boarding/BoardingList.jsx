    ...
    <div>
      ...
      <div className='light-gray-background'>
        <div className='container py-6 flex flex-row justify-between'>
          <div>
            <h2 className='uppercase text-2xl font-semibold'>cho thuê phòng trọ giá rẻ, mới nhất</h2>
            ...
            <div className="breadcrumb pb-4">
              <nav className="text-sm text-gray-500 flex items-center">
                ...
                <Link to="/boarding" className="hover:underline text-gray-400 mx-2 font-semibold">Phòng trọ</Link>
              </nav>
            </div>
